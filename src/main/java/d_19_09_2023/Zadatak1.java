...
package d_19_09_2023;

public class Zadatak1 {
    public static void main(String[] args) {

        SuperCard superCard = new SuperCard("328232-2823", "person1", 500);

        Cart cart = new Cart();

        cart.addPackaging(new Tetrapak("334343", "yoghurt", 850, 1000, true, 150));
        cart.addPackaging(new Tetrapak("65656", "juice", 200, 250, false, 60));
        cart.addPackaging(new Glass("77777", "cider", 1800, 2200,25, true, 200));
        cart.addPackaging(new Glass("23232323", "water", 1900, 2150, 60, true, 600));
        cart.addPackaging(new Glass("3634435", "energy drink", 430, 500,15, false, 600));

        cart.deletePackaging("77777");
