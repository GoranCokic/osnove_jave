...
public class Zadatak6 {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> expectedStatusCodes = new ArrayList<Integer>();
        ArrayList<Integer> actualStatusCodes = new ArrayList<Integer>();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            //IZ NEKOG RAZLOGA NE RADI NA PRVI NACIN ALI RADI NA DRUGI
            //prvi nacin
//            if (expectedStatusCodes.get(i) != actualStatusCodes.get(i)) {
...
//            }
            ...
            //ako budes hteo da proveris, samo stavi ovaj drugi nacin u komentare
            //drugi nacin
            int a = expectedStatusCodes.get(i);
            int b = actualStatusCodes.get(i);
            if (a != b) {
                System.out.println("Assertion Error: Link " + links.get(i) + " expected status code " + expectedStatusCodes.get(i) + " but got " + actualStatusCodes.get(i));
            }
        }
