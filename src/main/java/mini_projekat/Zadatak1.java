...
public class Zadatak1 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1.0 * velicinaFajla / 5; i++) {
            System.out.println("Unesite 5 karaktera:");
            sadrzajFajla = sadrzajFajla + s.next();
            System.out.println("Skinuto je " + 100.0 * sadrzajFajla.length() / velicinaFajla + "%");
        }
