...
public class Zadatak3 {
    public static void main(String[] args) {
        String sqlKomanda = "INSERT INTO Customers (CustomerName, ContactName, Address, City, PostalCode, Country) VALUES ('%0', '%1', '%2', '%3', '%4', '%5');";
        ArrayList<String> nizVrednosti = new ArrayList<String>();
        ...
        for (int i = 0; i < nizVrednosti.size(); i++) {
            sqlKomanda = sqlKomanda.replace("%" + i, nizVrednosti.get(i));
        }
        System.out.println(sqlKomanda);
    }
}
