...
public class Zadatak2 {
    public static void main(String[] args) {
        VisaKartica visaKartica = new VisaKartica(100,"brojKartice123",2020,11,"marko");
        MasterKartica masterKartica = new MasterKartica(100,"brojKartice567",2023,5);

        visaKartica.dodajSredstva(20);
        visaKartica.izvrsiTransakciju(10);
        visaKartica.stampa();

        masterKartica.dodajSredstva(20);
        masterKartica.izvrsiTransakciju(10);
        masterKartica.naplatiOdrzavanje();
        masterKartica.stampa();
